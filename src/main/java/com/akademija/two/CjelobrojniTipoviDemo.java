...
public class CjelobrojniTipoviDemo {
    public static void main(String[] args) {
        ...
        //1. evaluira se 34 ali kao int  2. automatska konverzija tipa u long 64  3. dodijeli se vrijednost
        long longNumber2 = 34;
        long longNumber3 = 34L; // 1. evaluira se kao 64 bit long 2. dodijeli se vrijednost
